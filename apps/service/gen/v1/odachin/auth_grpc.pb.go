...
const (
	AuthService_CreateUser_FullMethodName  = "/odachin.auth.AuthService/CreateUser"
	AuthService_UpdateUser_FullMethodName  = "/odachin.auth.AuthService/UpdateUser"
	AuthService_Login_FullMethodName       = "/odachin.auth.AuthService/Login"
	AuthService_GetUserInfo_FullMethodName = "/odachin.auth.AuthService/GetUserInfo"
	AuthService_GetOwnInfo_FullMethodName  = "/odachin.auth.AuthService/GetOwnInfo"
)
...
func (c *authServiceClient) GetOwnInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetOwnInfoResponse, error) {
	out := new(GetOwnInfoResponse)
	err := c.cc.Invoke(ctx, AuthService_GetOwnInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetOwnInfo(context.Context, *emptypb.Empty) (*GetOwnInfoResponse, error) {
...
func _AuthService_GetOwnInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetOwnInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetOwnInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetOwnInfo(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "odachin.auth.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetOwnInfo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "v1/odachin/auth.proto",
}
