...
export const file_v1_odachin_usage: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_empty, file_google_protobuf_timestamp, file_buf_validate_validate]);
...
/**
 * @generated from message odachin.reward.RejectUsageRequest
 */
export type RejectUsageRequest = Message<"odachin.reward.RejectUsageRequest"> & {
  /**
   * @generated from field: uint64 usage_id = 1;
   */
  usageId: bigint;
...
/**
 * Describes the message odachin.reward.RejectUsageRequest.
 * Use `create(RejectUsageRequestSchema)` to create a new message.
 */
export const RejectUsageRequestSchema: GenMessage<RejectUsageRequest> = /*@__PURE__*/
  messageDesc(file_v1_odachin_usage, 8);
...
export const UsageService: GenService<{
  ...
  /**
   * @generated from rpc odachin.reward.UsageService.RejectUsage
   */
  rejectUsage: {
    methodKind: "unary";
    input: typeof RejectUsageRequestSchema;
    output: typeof EmptySchema;
  },
}> = /*@__PURE__*/
